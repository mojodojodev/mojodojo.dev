...
## Official Content
- New notebook added: [Ray tracing in Mojo](https://docs.modular.com/mojo/notebooks/RayTracing.html) with some great examples including writing to a numpy ndarray.
