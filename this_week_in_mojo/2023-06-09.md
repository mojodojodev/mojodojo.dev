...
### 🦋 Changed
The data types and scalar names now conform to the naming convention used by numpy. So we use Int32 instead of Int32, similarly using Float32 instead of Float32. Closes Issue #152.
### 🛠️ Fixed
...
A direct conversion should be included in the next Playground release. Thanks for bringing this up.
